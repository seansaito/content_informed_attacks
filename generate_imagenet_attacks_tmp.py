...
if __name__ == '__main__':
  test_inception = TestInception()
  logger.warning("Testing clean accuracy")
  test_inception.test_clean_accuracy()

  test_spsa = TestSPSA()
  logger.warning('Testing attack success')
  test_spsa.test_attack_success()
